...
export default function TabNavigator() {
    return (
            <Tab.Navigator screenOptions={{unmountOnBlur: true}} >
                <Tab.Screen name="ShoppingListStack" component={ShoppingListStack} options={{ headerShown: false }}/>
                <Tab.Screen name="RecipesStack" component={RecipesStack} options={{ headerShown: false }}/>
                <Tab.Screen name="CookingBookStack" component={CookingBookStack} options={{ headerShown: false }}/>
                <Tab.Screen name="CookersStack" component={CookersStackScreen} options={{ headerShown: false }}/>
                <Tab.Screen name="WeekMenuStack" component={WeekMenuStack} options={{ headerShown: false }}/>
            </Tab.Navigator>
    );
}
